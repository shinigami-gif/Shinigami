...
/**
 * Streamix-owned HTML boundary.
 *
 * Jsoup remains the current implementation. Providers consume this boundary
 * so the parser implementation can be changed independently later.
 */
