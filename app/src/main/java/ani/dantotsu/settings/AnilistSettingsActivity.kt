...
class AnilistSettingsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.apply {
            ...
            val animeCustomLists = Anilist.animeCustomLists.orEmpty()
            animeCustomLists.forEach { listName ->
                addCustomListItem(listName, binding.animeCustomListsContainer)
            }

            binding.addAnimeListButton.setOnClickListener {
                addCustomListItem("", binding.animeCustomListsContainer)
            }
    ...
    private fun deleteCustomList(name: String) {
        lifecycleScope.launch {
            val success = anilistMutations.deleteCustomList(name, "ANIME")
            if (success) {
    ...
    private fun saveCustomLists() {
        val animeCustomLists = binding.animeCustomListsContainer.children
            ...
            .toList()
         lifecycleScope.launch {
            val success = anilistMutations.updateCustomLists(animeCustomLists, emptyList())
            if (success) {
